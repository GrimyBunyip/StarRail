...
def ArgentiHanabiTingyunHuohuo(config,
    ...
    ArgentiCharacter.addStat('CD',description='Sacerdos Hanabi',amount=0.18, stacks=2)
    ...
    ArgentiCharacter.addStat('CD',description='Sacerdos Tingyun',amount=0.18, stacks=4.0/3.0)
