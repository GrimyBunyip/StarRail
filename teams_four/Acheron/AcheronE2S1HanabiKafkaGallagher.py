...
def AcheronE2S1HanabiKafkaGallagher(config):
    ...
    #%% Acheron Hanabi Kafka Gallagher Rotations
    
    numStacks =  2.0 * KafkaCharacter.getTotalStat('SPD') # 2 kafka stacks per turn
    ...
    #%% Acheron Hanabi Kafka Gallagher Rotation Math
    ...
    return([AcheronEstimate, HanabiEstimate, KafkaEstimate, GallagherEstimate])