...
def AcheronKafkaBlackSwanGallagher(config):
    ...
    GallagherCharacter = Gallagher(RelicStats(mainstats = ['ER', 'SPD.flat', 'HP.percent', 'DEF.percent'],
                            ...
                            relicsetone = ThiefOfShootingMeteor2pc(), relicsettwo = ThiefOfShootingMeteor4pc(), planarset = FleetOfTheAgeless(),
                            **config)
    ...
    for character in [KafkaCharacter, AcheronCharacter, BlackSwanCharacter]:
        character.addStat('ATK.percent',description='Fleet from Gallagher',amount=0.08)
