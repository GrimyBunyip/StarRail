...
def AcheronE2S1BronyaJiaoqiuE2Gallagher(config):
    ...
    AcheronEstimate = DefaultEstimator(f'Acheron E{AcheronCharacter.eidolon:d} S{AcheronCharacter.lightcone.superposition:d} {AcheronCharacter.lightcone.shortname}: {numBasicAcheron:.1f}N {numSkillAcheron:.1f}E 1Q', AcheronRotation, AcheronCharacter, config)
