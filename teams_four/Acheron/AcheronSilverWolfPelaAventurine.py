...
def AcheronSilverWolfPelaAventurine(config, acheronSuperposition:int=0):
    ...
    # Silver Wolf Debuffs
    SilverWolfCharacter.applyDebuffs([SilverWolfCharacter, AventurineCharacter],numSkillUses=2)
