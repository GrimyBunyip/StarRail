...
def KafkaGuinaifenBlackSwanLuocha(config):
    ...
    GuinaifenStacks = 2 * GuinaifenCharacter.numEnemies
    GuinaifenStackRate = GuinaifenStacks * GuinaifenCharacter.getTotalStat('SPD') / 4
    ...
    netStackRate = (KafkaStackRate + GuinaifenStackRate + SwanStackRate) / KafkaCharacter.enemySpeed / KafkaCharacter.numEnemies + 3
