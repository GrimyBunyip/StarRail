...
def ClaraE3S1TingyunHanabiFuxuan(config):
    ...
    numSvarogCounters = numEnemyAttacks * (5*11) / (5*11 + 6 + 4 + 4)

    ClaraRotation = [ # 110 max energy
            ClaraCharacter.useSkill() * numSkillClara,
            ClaraCharacter.useMarkOfSvarog() * numSkillClara * ClaraCharacter.numEnemies, # E1 implementation 
