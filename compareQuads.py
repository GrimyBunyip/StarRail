...
# visualizationList.append(FeixiaoMarchRobinAventurine(config, robinEidolon=2, robinLightCone='ForTomorrowsJourney'))
# visualizationList.append(FeixiaoMarchRobinAventurine(config, robinEidolon=2, robinLightCone='FlowingNightglow'))
# visualizationList.append(FeixiaoMarchRobinAventurine(config, robinEidolon=2, feixiaoLightCone='IVentureForthToHunt', robinLightCone='ForTomorrowsJourney'))
# visualizationList.append(FeixiaoMarchRobinAventurine(config, robinEidolon=2, feixiaoEidolon=1, robinLightCone='ForTomorrowsJourney'))
# visualizationList.append(FeixiaoMarchRobinAventurine(config, robinEidolon=2, feixiaoEidolon=2, robinLightCone='ForTomorrowsJourney'))
