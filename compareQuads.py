...
# Hanya A6 and Messenger 4 pc
for character in [JingliuCharacter, BladeCharacter, LuochaCharacter]:
    character.addStat('DMG',description='Hanya A6',amount=0.10)
    character.addStat('SPD.percent',description='Messenger 4 pc',amount=0.12,uptime=1.0/5.0)
...
visualizationList.append([JingliuEstimate, HanyaEstimate, BladeEstimate, LuochaEstimate])
...
HanyaEstimate = DefaultEstimator('Hanya {:.0f}E {:.0f}Q S{:.0f} {}, 12 Spd Substats'.format(numHanyaSkill, numHanyaUlt,
                                ...
                                HanyaRotation, HanyaCharacter, config)
TingyunEstimate = DefaultEstimator('Tingyun (Speed Tuned) 1N 2E 1Q S{:.0f} {}'.format(TingyunCharacter.lightcone.superposition, TingyunCharacter.lightcone.name), 
                                  TingyunRotation, TingyunCharacter, config)
LuochaEstimate = DefaultEstimator('Luocha: 3N 1E 1Q, S{:.0f} {}'.format(LuochaCharacter.lightcone.superposition, LuochaCharacter.lightcone.name), 
                                  LuochaRotation, LuochaCharacter, config)

visualizationList.append([LunaeEstimate,HanyaEstimate,TingyunEstimate,LuochaEstimate])
...
#%% Seele MAX Silver Wolf Bronya Characters
...
#%% Seele MAX Silver Wolf Bronya Team Buffs
...
#%% Seele MAX Silver Wolf Bronya Print Statements
SeeleCharacter.print()
SilverWolfCharacter.print()
BronyaCharacter.print()
LuochaCharacter.print()

#%% Seele MAX Silver Wolf Bronya Rotations
...
#%% Seele MAX SilverWolf Bronya Luocha Rotation Math
...
SeeleEstimate.effect.actionvalue *= BronyaRotationDuration / ( 4 * SeeleRotationDuration )
